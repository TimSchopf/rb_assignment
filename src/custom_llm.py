...
def call_llm_with_retries(client: LLMClient, llm_name: str, prompts: list[dict] | None = None, user_prompt: str | None = None, schema=None, system_prompt: str | None = None, temperature: float | None = 0, return_json: bool = False, max_retries: int = 3, retry_backoff: float = 1.0):
    """
    ...
    Args:
        ...
        prompts (list(dict),optional): List of prompts to use for the LLM.
        user_prompt (str,optional): Input text prompt for the LLM.
